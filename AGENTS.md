...
Weekly scorecard app for tracking personal growth goals across health, soft skills, and education — replaces an expensive coach with structured self-assessment.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "282944200+Janahgir@users.noreply.github.com"
  git config user.name "Janahgir"
  ```
